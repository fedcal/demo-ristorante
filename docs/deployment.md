...
URL: `https://ristorante.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `ristorante.demo.federicocalo.dev`
...
- Output directory: `dist/ristorante/browser`
...
URL: `https://fedcal.github.io/federico-demo-ristorante/`
...
- `base: /federico-demo-ristorante/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `ristorante-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   ristorante-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `ristorante-docs.federicocalo.dev`
